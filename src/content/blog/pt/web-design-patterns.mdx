...
date: 2021-08-10
summary: "O que são SSR, SSG e SPA, como se comparam, e qual escolher para um site de documentação, um blog e um CRM."
category: software
---
...
![Renderização no servidor em seis passos: o utilizador pede um website, o servidor cria os ficheiros HTML prontos, o browser renderiza o HTML mas ainda não é interativo, descarrega o Javascript, executa-o, e o website fica totalmente interativo.](/images/blog/web-design-patterns/ssr.webp)
...
![Pré-renderização em seis passos: o utilizador pede um website, o servidor envia um ficheiro HTML estático com recursos Javascript, o browser renderiza o HTML e descarrega o Javascript, o utilizador vê a página estática sem interatividade, é redirecionado para o ficheiro certo, e o website fica totalmente interativo.](/images/blog/web-design-patterns/ssg.webp)
...
![Renderização no cliente em seis passos: o utilizador pede um website, o servidor envia um ficheiro HTML com ligações para Javascript, o browser descarrega o HTML, depois o CSS e o Javascript, executa a framework ou biblioteca, e carrega o website.](/images/blog/web-design-patterns/spa.webp)
